...
const translations = {
    zh: {
        ...
        'filter-type': '按类型：',
        'platform-restriction-note': '注意：如果你所在的地区无法访问 YouTube，可在其他平台（如 Bilibili 或 Apple Podcasts）上搜索同名资源。为了应对这样的平台限制，小站也为部分资源提供了多个来源，同时请注意不同平台上的内容可能略有差异。',
        'filter-level': '按难度：',
        'level-elementary': '初级',
        'level-lower-intermediate': '中下级',
        'level-intermediate': '中级',
        'level-upper-intermediate': '中上级',
        'level-advanced': '高级',
        'all': '全部',
        'reading': '阅读',
        'listening': '听力',
        ...
        'other-creators-title': '其他优质创作者推荐',
        'other-creators-all-learners': '适合所有英语学习者',
        'other-creators-toefl-ielts': '适合托福/雅思学习者',
        'references': '参考文献',
    ...
    en: {
        ...
        'filter-type': 'By Type:',
        'platform-restriction-note': 'Note: If YouTube is not accessible in your region, you may search for the same resource on other platforms such as Bilibili or Apple Podcasts. Listening & Reading Station also offers multiple sources to address such platform restrictions, and please note that content may vary slightly across platforms.',
        'filter-level': 'By Level:',
        'level-elementary': 'Elementary',
        'level-lower-intermediate': 'Lower-Intermediate',
        ...
        'youtube-link-name': 'YouTube',
        'alternate-link-name': 'Alternate Link',
